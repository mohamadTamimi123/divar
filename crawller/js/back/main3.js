...
(async () => {
    ...
    const url = 'https://divar.ir/s/karaj/buy-apartment?business-type=personal';
    ...
    for (const post of posts) {
        try {
            ...
            await new Promise(r => setTimeout(r, 4000)); // صبر برای لود
    ...
    // ذخیره در فایل JSON
    fs.writeFileSync('divar_data.json', JSON.stringify(details, null, 2), 'utf-8');
    console.log('💾 داده‌ها در فایل divar_data.json ذخیره شدند.');
